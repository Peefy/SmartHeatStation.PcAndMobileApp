...
[assembly: Dependency(typeof(SmartHeatStation.iOS.Sqlite.DatabaseConnectionIOS))]

namespace SmartHeatStation.iOS.Sqlite
{
    public class DatabaseConnectionIOS : SmartHeatStation.Sqlite.IDatabaseConnection
    {
